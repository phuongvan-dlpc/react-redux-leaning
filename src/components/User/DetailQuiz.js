...
const DetailQuiz = (props) => {
    ...
    const [isShowMadalResult, setIsShowMadalResult] = useState(false);
    ...
    const handleFinishQuiz = async () => {
        ...
        if (dataQuiz && dataQuiz.length > 0) {
            ...
            console.log("check res submit api: ", res);
            if (res && res.EC === 0) {
                setDataModalResult({
    ...
    return (
        <div className="detail-quiz-container">
            ...
            <ModalResult
                show={isShowMadalResult}
                setShow={setIsShowMadalResult}
